 ...
 *
 * <ul>
 *   <li>TWO different relationship types between the same pair (Cave both wrote and scored The
 *       Proposition) - the multigraph requirement, in one case
 *   <li>Edges asserted by two independent sources, so corroboration has something to count
...
public final class Fixture {
  ...
  public static List<AssertionRecord> assertions() {
    return List.of(
        ...
        wikidata(
            HARVEY_MICK, "MEMBER_OF", BAD_SEEDS, "1983-01-01", "2009-01-31", "S-mick-badseeds"),
  ...
  private static AssertionRecord wikidata(
      String from, String type, String to, String validFrom, String validTo, String ref) {
  ...
  private static AssertionRecord musicbrainz(
      String from, String type, String to, String validFrom, String validTo, String ref) {
    return new AssertionRecord(
        from,
        to,
  ...
  private static AssertionRecord lastfm(String from, String type, String to, String ref) {
    return new AssertionRecord(
        from, to, type, null, null, new Provenance("lastfm", ref, LASTFM_PULL, 0.50));
  }
