 ...
 *
 * <p>Entities use REAL Wikidata IRIs, which is the quiet advantage of this
 * adapter: a Wikidata dump or a live SPARQL federation can be loaded straight
 * into the same store with no identifier mapping layer at all.
 *
 * <p>Predicates use a local namespace rather than Wikidata's, because the
 * orientation is ours (person DIRECTED film, not film P57 person). The mapping
 * back to Wikidata properties lives in EdgeTypes.
 */
