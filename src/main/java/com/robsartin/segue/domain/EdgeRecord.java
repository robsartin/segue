...
/**
 * A relationship as the graph currently believes it, carrying every assertion
 * that supports it. Multiple sources agreeing collapse into ONE edge with
 * several provenance entries - that collapse is what makes corroboration
 * countable. Different relationship TYPES between the same pair stay separate
 * edges, which is why the store has to be a multigraph.
 */
