...
public record KnownListCensus(String file, Population fromFile, Population withPromotions) {
   ...
   *     zero and no source under {@code unavailable} — the two new cells guard a per-neighbour
   *     Wikidata loss a later run could still recover. A refusal reason of {@code local entity}
